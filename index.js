...
function getBounds(nightmare, selector, offsetX, offsetY) {
    return new Promise(function(resolve, reject) {
        nightmare.evaluate_now(function(selector, offsetX, offsetY) {
...
function center(bounds) {
    ...
    var offsetX = bounds.x == undefined ? bounds.width / 2 : bounds.x;
    var offsetY = bounds.y == undefined ? bounds.height / 2 : bounds.y;
    return {
        x: Math.floor(bounds.left + offsetX),
        y: Math.floor(bounds.top + offsetY)
    };
}
